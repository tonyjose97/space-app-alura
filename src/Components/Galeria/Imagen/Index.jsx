...
const Imagen = ({ foto, expandida = false, alSolicitarZoom, alternarFavoritos}) => {
  const iconoFavorito = foto.favorita
    ? "../public/iconos/favorito-activo.png"
    : "../public/iconos/favorito.png";
  ...
  return (
    <Figure $expandida={expandida} id={`foto-${foto.id}`}>
      ...
      <figcaption>
        ...
        <Pie>
          <h4>{foto.fuente}</h4>
          <BotonIcono onClick={() => alternarFavoritos(foto)}>
          ...
          {!expandida && (
            <BotonIcono
              ...
              <img
                src="../public/iconos/expandir.png"
